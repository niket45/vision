...
class YoloDetector(BaseDetector):
    """YOLOv11 implementation of the BaseDetector interface."""
    ...
    def __init__(self, model_path: str | Path, device: str = "cpu"):
        ...
        try:
            ...
            raise ImportError(
                "ultralytics is required to use YoloDetector. "
        ...
        # Force model to device to ensure correct execution context
        self.model.to(self.device)

        # Mapping of class index to Region subclass based on our dataset.yaml
        # 0: bubble, 1: narration, 2: text, 3: sfx, 4: panel
        self._class_map = {
            0: BubbleRegion,
            1: NarrationRegion,
            2: TextRegion,
    ...
    def detect(self, image_path: Path, confidence_threshold: float = 0.5) -> VisionResult:
        ...
        # Run inference
        # imgsz=1024 to match our training configuration
    ...
    def detect_batch(
        ...
        # YOLO batch inference time (divide evenly among images for metadata)
